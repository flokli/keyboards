 ...
 * \brief Media layer.
 *
 * Tertiary left- and right-hand layer is media and RGB control.
 */
  [LAYER_MEDIA] = LAYOUT_split_3x5_3(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, UG_TOGG, UG_NEXT, UG_HUEU, UG_SATU, UG_VALU,
...
/** \brief Mouse emulation and pointer functions. */
  [LAYER_POINTER] = LAYOUT_split_3x5_3(
    ...
    _______, DRGSCRL, SNIPING, MS_BTN3, XXXXXXX, XXXXXXX, MS_WHLL, MS_WHLD, MS_WHLU, MS_WHLR,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [LAYER_POINTER]    = {ENCODER_CCW_CW(UG_HUED, UG_HUEU),  ENCODER_CCW_CW(UG_SATD, UG_SATU)},
    [LAYER_NUMERAL]    = {ENCODER_CCW_CW(UG_VALD, UG_VALU),  ENCODER_CCW_CW(UG_SPDD, UG_SPDU)},
    [LAYER_SYMBOLS]    = {ENCODER_CCW_CW(UG_PREV, UG_NEXT), ENCODER_CCW_CW(KC_LEFT, KC_RGHT)},
};
// clang-format on
